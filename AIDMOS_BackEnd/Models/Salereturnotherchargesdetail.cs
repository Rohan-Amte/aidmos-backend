...
[Table("salereturnotherchargesdetails")]
public partial class Salereturnotherchargesdetail
{
    [Key]
    [Column("id", TypeName = "numeric(18, 0)")]
    public decimal Id { get; set; }

    [Column("salereturnid", TypeName = "numeric(18, 0)")]
    public decimal? Salereturnid { get; set; }
