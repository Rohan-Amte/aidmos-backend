...
public partial class Receiptnote
{
    ...
    [InverseProperty("Receiptnote")]
    public virtual ICollection<Receiptnoteotherchargesdetail> Receiptnoteotherchargesdetails { get; set; } = new List<Receiptnoteotherchargesdetail>();
}
